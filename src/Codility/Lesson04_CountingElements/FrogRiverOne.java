...
/*
 * Task description A small frog wants to get to the other side of a river. The
 * frog is initially located on one bank of the river (position 0) and wants to
 * get to the opposite bank (position X+1). Leaves fall from a tree onto the
 ...
 * is an integer within the range [1..X]. Copyright 2009–2022 by Codility
