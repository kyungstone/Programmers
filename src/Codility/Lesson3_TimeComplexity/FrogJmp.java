 ...
 * 
 * X, Y and D are integers within the range [1..1,000,000,000]; X ≤ Y. Copyright
 * 2009–2022 by Codility Limited. All Rights Reserved. Unauthorized copying,
...
public class FrogJmp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Result : " + frogJmp.solution(X, Y, D));
	}
