 ...
 * 있습니다. 입출력 예 participant completion return ["leo", "kiki", "eden"] ["eden",
 * "kiki"] "leo" ["marina", "josipa", "nikola", "vinko", "filipa"] ["josipa",
 * "filipa", "marina", "nikola"] "vinko" ["mislav", "stanko", "mislav", "ana"]
 * ["stanko", "ana", "mislav"] "mislav" 입출력 예 설명 예제 #1 "leo"는 참여자 명단에는 있지만, 완주자
 * 명단에는 없기 때문에 완주하지 못했습니다.
 * 
